...
batch_size = 64     # larger stable training, smaller for saving memory GPU
...
max_iters = 5000                    # larger for longer training(might increase accuracy), smaller for faster runs
...
beta2 = 0.99                        # larger for more stable training, smaller for faster convergence
