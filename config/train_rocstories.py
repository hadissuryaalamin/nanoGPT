...
dropout = 0.15                       # larger for less overfitting, smaller for overfitting
learning_rate = 1e-2                # larger for faster training, smaller for better accuracy
max_iters = 7000                    # larger for longer training(might increase accuracy), smaller for faster runs
lr_decay_iters = 3500   # starting step for learning rate decay
