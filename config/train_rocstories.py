...
n_layer = 7         # larger for better reasoning(complexity understanding)
...
max_iters = 50000                    # larger for longer training(might increase accuracy), smaller for faster runs
lr_decay_iters = 50000               # starting step for learning rate decay
